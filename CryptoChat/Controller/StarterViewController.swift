...
class StarterViewController: UIViewController {
    ...
    let animationView = LottieAnimationView(name: "OrangeBubble")

    override func viewWillAppear(_ animated: Bool) {
        //TODO:Remove next two lines on production
//        UserDefaults.standard.removeObject(forKey: "firstLaunchingLaunch")
//        UserDefaults.standard.synchronize()
    ...
    private func signedUser() {
        if Auth.auth().currentUser?.uid != nil {
            DatabaseMng.shared.getInitialInfo(userID: Auth.auth().currentUser!.uid) { userLocalInformation in
