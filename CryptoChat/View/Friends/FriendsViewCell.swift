...
class FriendsViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        contentView.addSubview(isContactImageView)
...
//        imageView.image = UIImage(systemName: "person.crop.circle.fill")
    ...
    private let isContactImageView: UIImageView = {
        let imageView = UIImageView()
    ...
    override func layoutSubviews() {
        ...
        isContactImageView.frame = CGRect(x: widthCell - (widthCell * 0.2),
    ...
    public func configure(with model: Friend) {
        ...
        if !model.isContact {
            isContactImageView.isHidden = false
        } else {
            isContactImageView.isHidden = true
        }
